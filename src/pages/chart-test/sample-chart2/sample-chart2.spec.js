describe('page', function () {
    describe('chart-test', function () {
        ...
        describe('sample-chart2', function () {
            describe('directive', function () {
                ...
                beforeEach(function () {
                    ...
                    angular.mock.inject(function ($rootScope, $compile) {
                        ...
                        element = angular.element('<sample-chart2></sample-chart2>');
                        $scope = $rootScope;
            ...
            describe('controller', function () {
                var Controller = require('./sample-chart2.ctrl.js');
                var controller;
                var _$interval;
                var updateCalled;
                var $scope;
                ...
                it('should add data every second', function () {
                    ...
                    expect(controller.data[0].values.length).to.equal(1);
                    _$interval.flush(1000);
                    expect(controller.data[0].values.length).to.equal(2);
                    _$interval.flush(100000);
